...
const SectionButton = (props) => {
    return <button className=" grow basis-1/10 text-PRIMARY_COLOR relative flex justify-center items-center py-2 text-xl  overflow-hidden transition-all bg-SECONDARY_COLOR rounded hover:bg-PRIMARY_COLOR px-4  hover:text-SECONDARY_COLOR group">
