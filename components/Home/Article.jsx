...
const Article = (props) => {
  return (
    <div className="lg:basis-1/3  md:basis-1/2 grow ">
      <article className="relative flex  flex-col border border-LIGHT_GREY rounded-lg   flex-wrap group hover:cursor-pointer hover:bg-SECONDARY_COLOR md:mr-8 my-4">
