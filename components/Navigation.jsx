                ...
                <div className="flex items-center w-full lg:justify-center">
                  ...
                  <div className="flex items-center justify-between w-fit">
                    <div className="flex hidden sm:ml-6 lg:block">
                      <div className="flex items-center justify-between pt-4 xl:text-sm 2xl:text-base md:text-xs xl:space-x-6 md:space-x-2">
                        {navigation.map((item) => (
                          <Link
                            key={item.name}
                            href={item.href}
                    ...
                    <div className="flex flex-col hidden py-2 mx-4 lg:block">
                      ...
                      <div className="flex items-center gap-2 grow">
                        <button
                          onClick={() => setShowSearchModal(true)}
                          className="flex-col items-center w-8 h-8 py-2 justify-strech rounded-xl text-BACKGROUND_COLOR"
                        >
                          <HiSearch className="text-xl" />
                        </button>
                        <button
                          onClick={() => setShowEnquireModal(true)}
                          className="p-[.3px] rounded-md w-full h-8 bg-BACKGROUND_COLOR text-xs"
                        >
                          Enquire Now
                        </button>
                      </div>
                      <div className="flex items-center gap-4 my-1 justify-evenly">
                        <button
                          ...
                          className="text-sm cursor-pointer text-BACKGROUND_COLOR hover:text-SECONDARY_COLOR"
                        >
                          Login
                        </button>
                        <button
            ...
            <Disclosure.Panel className="xl:hidden scroll-auto snap-y overscroll-contain overflow-y-scroll h-[60vh] ">
              <div className="px-2 pt-2 pb-3 space-y-1">
                ...
                <Disclosure.Button
                  ...
                  onClick={() => setShowLoginModal(true)}
                  className={classNames(
                    "w-full text-BACKGROUND_COLOR hover:text-SECONDARY_COLOR hover:bg-BACKGROUND_COLOR block px-3 py-2 text-start text-xl font-bold border-b-2"
                  )}
                >
                  LOGIN
                </Disclosure.Button>
                <Disclosure.Button
                  ...
                  href={"/contact"}
                  className={classNames(
                    "text-BACKGROUND_COLOR hover:text-SECONDARY_COLOR hover:bg-BACKGROUND_COLOR block px-3 py-2  text-xl font-bold border-b-2"
                  )}
                >
                  REGISTER
                </Disclosure.Button>
