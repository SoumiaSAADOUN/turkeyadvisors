            ...
            <div className="relative w-[450px] mx-auto max-w-3xl">
              ...
              <div className=" shadow-lg relative flex flex-col w-full bg-BACKGROUND_COLOR outline-none focus:outline-none">
                ...
                <div className="relative p-4 flex-auto">
                  <input
                    className="appearance-none bg-transparent border-b-PRIMARY_COLOR border-b-[1px]   pb-4 w-full text-lg text-PRIMARY_COLOR mr-3  px-4 leading-tight focus:outline-none focus:border-b-SECONDARY_COLOR mb-2"
                    type="text"
                    placeholder={`Your Name`}
                  />
                  <input
                    className="appearance-none bg-transparent border-b-PRIMARY_COLOR border-b-[1px]   py-4 w-full text-lg text-PRIMARY_COLOR mr-3  px-4 leading-tight focus:outline-none focus:border-b-SECONDARY_COLOR mb-2"
                    type="email"
                ...
                <div className="flex items-center w-full">
                  <button
                    className="flex justify-center text-SECONDARY_COLOR rounded mx-4 my-2 bg-DARK_PRIMARY_COLOR font-bold py-3 hover:bg-PRIMARY_COLOR focus:outline-none w-full mb-12"
                    type="button"
